...
public class Connection   {
   ...
   **/
  public Connection updateRequestedAt(Date updateRequestedAt) {
   ...
   **/
  public Connection lastSuccessfulUpdatedAt(Date lastSuccessfulUpdatedAt) {
   ...
   **/
  public Connection createdAt(Date createdAt) {
   ...
   **/
  public Connection updatedAt(Date updatedAt) {
